...
\rfoot{\textbf{PRÁCTICA SEMANA 9 (R)}}
...
\section{Diseño Completamente Aleatorio con efectos fijos (Diseño unifactorial de efectos fijos)}
...
\hline
\begin{tabular}[c]{@{}l@{}}Días de la\\      semana\end{tabular} & \multicolumn{8}{l|}{Concentraciones   de monóxido de carbono}                                                                                                                                    \\ \hline
Lunes                                                            & \multicolumn{1}{l|}{420} & \multicolumn{1}{l|}{390} & \multicolumn{1}{l|}{480} & \multicolumn{1}{l|}{430} & \multicolumn{1}{l|}{440} & \multicolumn{1}{l|}{324} & \multicolumn{1}{l|}{450} & 460 \\ \hline
Martes                                                           & \multicolumn{1}{l|}{450} & \multicolumn{1}{l|}{390} & \multicolumn{1}{l|}{430} & \multicolumn{1}{l|}{521} & \multicolumn{1}{l|}{320} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{342} & 423 \\ \hline
Miércoles                                                        & \multicolumn{1}{l|}{355} & \multicolumn{1}{l|}{462} & \multicolumn{1}{l|}{286} & \multicolumn{1}{l|}{238} & \multicolumn{1}{l|}{344} & \multicolumn{1}{l|}{423} & \multicolumn{1}{l|}{123} & 196 \\ \hline
Jueves                                                           & \multicolumn{1}{l|}{321} & \multicolumn{1}{l|}{254} & \multicolumn{1}{l|}{412} & \multicolumn{1}{l|}{368} & \multicolumn{1}{l|}{340} & \multicolumn{1}{l|}{258} & \multicolumn{1}{l|}{433} & 489 \\ \hline
Vlemes                                                           & \multicolumn{1}{l|}{238} & \multicolumn{1}{l|}{255} & \multicolumn{1}{l|}{366} & \multicolumn{1}{l|}{389} & \multicolumn{1}{l|}{198} & \multicolumn{1}{l|}{256} & \multicolumn{1}{l|}{248} & 324 \\ \hline
\end{tabular}
\caption{Tabla de datos del supuesto práctico 1}
\end{center}
\end{table}

\textbf{En el Supuesto práctico 1:}

\begin{itemize}
\item Variable respuesta: Concentración de CO.
\item Factor: Día de la semana que tiene cinco niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar (5 días de la semana).
\item Modelo equilibrado: Los niveles de los factores tienen el mismo número de elementos (8 elementos).
\item Tamaño del experimento: Número total de observaciones, en este caso 40 unidades experimentales.
\end{itemize}
...
donde:
\begin{itemize}
\item Concentracion = nombre de la columna de las observaciones.
\item Dia = nombre de la columna en la que están representados los tratamientos.
...
\\
En la expresión del comando “aov” indicar el factor
...
Los datos se muestren en un solo vector que tiene todos los datos de la contaminación tanto si se ha medido el lunes, el martes, el miércoles, el jueves o el viernes
...
\subsubsection{Hipótesis de homocedasticidad}
...
\subsubsection{Hipótesis de independencia}
...
\caption{ Estudio gráfico de la hipótesis de independencia}
\end{center}
\end{figure}
...
\subsubsection{Comparaciones múltiples}
...
\begin{itemize}
\item diff: muestra las medias de cada par
\item p adj: muestra los p-valores de los contrastes, que permiten conocer si la diferencia entre cada pareja de medias es significativa al nivel de significación considerado (en este caso 0.05)
\item lwr y upr: proporcionan los intervalos de confianza al 95\% para cada diferencia.
\end{itemize}
...
\section{Diseño Unifactorial de efectos aleatorios}
...
\hline
\textbf{Fabricantes} & \multicolumn{9}{l|}{\textbf{Número de colonias (en   millares)}}                                                                                                                                                            \\ \hline
Fabricantel          & \multicolumn{1}{l|}{120} & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{180} & \multicolumn{1}{l|}{144} & \multicolumn{1}{l|}{300} & 240 \\ \hline
Fabricante2          & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{180} & \multicolumn{1}{l|}{180} & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & 360 \\ \hline
Fabricante3          & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{270} & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & 300 \\ \hline
Fabricanle4          & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & 300 \\ \hline
Fabricanle5          & \multicolumn{1}{l|}{300} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{240} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{360} & \multicolumn{1}{l|}{300} & 360 \\ \hline
\end{tabular}
\caption{Tabla de datos del supuesto práctico 2}
\end{center}
\end{table}
...
\begin{itemize}
\item Calidad = nombre de la columna de las observaciones.
\item Fabricante = nombre de la columna en la que están representados los tratamientos.
\item data = data.frame en el que están guardados los datos.
\end{itemize}
...
\section{Diseño en Bloques Aleatorizados}
...
\hline
              & \multicolumn{10}{l|}{Abetos (Bloques)}                                                                                                                                                                                                     \\ \hline
Tratamientos  & \multicolumn{1}{l|}{1}  & \multicolumn{1}{l|}{2}  & \multicolumn{1}{l|}{3}  & \multicolumn{1}{l|}{4}  & \multicolumn{1}{l|}{5}  & \multicolumn{1}{l|}{6}  & \multicolumn{1}{l|}{7} & \multicolumn{1}{l|}{8} & \multicolumn{1}{l|}{9}  & 10 \\ \hline
Tratamiento 1 & \multicolumn{1}{l|}{7}  & \multicolumn{1}{l|}{8}  & \multicolumn{1}{l|}{9}  & \multicolumn{1}{l|}{10} & \multicolumn{1}{l|}{11} & \multicolumn{1}{l|}{8}  & \multicolumn{1}{l|}{7} & \multicolumn{1}{l|}{8} & \multicolumn{1}{l|}{7}  & 8  \\ \hline
Tratamiento 2 & \multicolumn{1}{l|}{9}  & \multicolumn{1}{l|}{9}  & \multicolumn{1}{l|}{9}  & \multicolumn{1}{l|}{9}  & \multicolumn{1}{l|}{12} & \multicolumn{1}{l|}{10} & \multicolumn{1}{l|}{8} & \multicolumn{1}{l|}{8} & \multicolumn{1}{l|}{9}  & 9  \\ \hline
Tratamiento 3 & \multicolumn{1}{l|}{10} & \multicolumn{1}{l|}{10} & \multicolumn{1}{l|}{12} & \multicolumn{1}{l|}{12} & \multicolumn{1}{l|}{14} & \multicolumn{1}{l|}{9}  & \multicolumn{1}{l|}{7} & \multicolumn{1}{l|}{7} & \multicolumn{1}{l|}{10} & 10 \\ \hline
\end{tabular}
\caption{Tabla de datos del supuesto practico 3}
\end{center}
\end{table}
...
\item El número de semillas observadas se muestra en la Tabla 4.
\item Variable respuesta: Número de semillas
\item Factor: Tratamiento que tiene tres niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar.
\item Bloque: Abeto que tiene diez niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar.
\item Modelo completo: Los tres tratamientos se prueban en cada bloque exactamente una vez.
\item Tamaño del experimento: Número total de observaciones (30).
\end{itemize}
...
\begin{itemize}
\item y es el nombre de la columna de las observaciones
\item Tratamiento es el nombre de la columna en la que están representados los tratamientos
\item Abeto es el nombre de la columna en la que están representados los bloques
\item data = data.frame en el que están guardados los datos
\end{itemize}
...
\begin{figure}[H]
\begin{center}
\includegraphics{Rplot5}
\caption{Estudio gráfico de la hipótesis de normalidad mediante el gráfico Q-Q Plot}
\end{center}
\end{figure}
...
\subsubsection{Hipótesis de Homogeneidad de Varianzas}
...
\begin{figure}[H]
\begin{center}
\includegraphics{Rplot6}
\caption{Estudio gráfico de la hipótesis de independencia de los residuos}
\end{center}
\end{figure}
...
>{\columncolor[HTML]{34CDF9}}c |}
\hline
                    & \multicolumn{6}{c|}{\cellcolor[HTML]{34CDF9}\textbf{Días}}                                                                                                                                                                                                   \\ \hline
\textbf{Soluciones} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}1}  & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}2}  & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}3}  & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}4}  & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}5}  & 6  \\ \hline
\textbf{Solución 1} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}12} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}24} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}31} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   &    \\ \hline
\textbf{Solución 2} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}21} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}20} & 21 \\ \hline
\textbf{Solución 3} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}19} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}18} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & 19 \\ \hline
\textbf{Solución 4} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}15} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}19} & \multicolumn{1}{c|}{\cellcolor[HTML]{34CDF9}47} &    \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 4}
\end{center}
\end{table}
...
\begin{itemize}
\item Variable respuesta: Número de bacterias
\item Factor: Soluciones que tiene cuatro niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar.
\item Bloque: Días que tiene seis niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar.
\item Modelo incompleto: Todos los tratamientos no se prueban en cada bloque.
...
\section{Diseño en Cuadrados Latinos}
...
>{\columncolor[HTML]{67FD9A}}c |}
\hline
                & \multicolumn{6}{c|}{\cellcolor[HTML]{67FD9A}\textbf{concentracion de acido}}                                                                                                                                                                                                  \\ \hline
\textbf{Lote}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}1}     & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}2}     & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}3}    & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}4}     & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}5}     & 6     \\ \hline
\textbf{Lote 1} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}12A}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}24B}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}10C}  & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}18D}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}21D} & 18 F  \\ \hline
\textbf{Lote 2} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}21B}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}26C}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}24D}  & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}16D} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}20F}   & 21A   \\ \hline
\textbf{Lote 3} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}20C}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}16D}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}19 E} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}18 F}  & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}16A}   & 19B   \\ \hline
\textbf{Lote 4} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}22D}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}15E} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}14F}  & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}19A}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}27B}   & 17C   \\ \hline
\textbf{Lote 5} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}15D} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}13F}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}17A}  & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}25B}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}21C}   & 22D   \\ \hline
\textbf{Lote 6} & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}17F}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}11A}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}12B}  & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}22C}   & \multicolumn{1}{c|}{\cellcolor[HTML]{67FD9A}14D}   & 20 E \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 5}
\end{center}
\end{table}
...
\section{Diseño en Cuadrados Greco-Latinos}
...
>{\columncolor[HTML]{FFCCC9}}c |}
\hline
\multicolumn{4}{|c|}{\cellcolor[HTML]{FFCCC9}\textbf{Cuadrado G-L 4}}                                                                                                                                                                                                                                                                           \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}} \hspace{0.5cm} A \hspace{0.5cm}\\    \\  $\alpha$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}} \hspace{0.5cm} B \hspace{0.5cm}\\    \\ $\beta$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}} \hspace{0.5cm} C \hspace{0.5cm}\\    \\  $\gamma$\end{tabular}} & \begin{tabular}[c]{@{}c@{}}D\\    \\ $\delta$\end{tabular}  \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}} \hspace{0.5cm} D \hspace{0.5cm}\\    \\  $\gamma$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}C\\    \\ $\delta$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}B\\    \\ $\alpha$\end{tabular}}  & \begin{tabular}[c]{@{}c@{}}A\\    \\  $\beta$\end{tabular} \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}B\\    \\ $\delta$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}A\\    \\ $\gamma$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}D\\    \\ $\beta$\end{tabular}}  & \begin{tabular}[c]{@{}c@{}}C\\    \\ $\alpha$\end{tabular}  \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}C\\    \\ $\beta$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}D\\    \\  $\alpha$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{FFCCC9}\begin{tabular}[c]{@{}c@{}}A\\    \\ $\delta$\end{tabular}}  & \begin{tabular}[c]{@{}c@{}}B\\    \\ $\gamma$\end{tabular}  \\ \hline
\end{tabular}
\caption{Ejemplo de  un cuadrado greco-latino para K=4}
\end{center}
\end{table}
...
>{\columncolor[HTML]{CBCEFB}}c |}
\hline
\multicolumn{6}{|c|}{\cellcolor[HTML]{CBCEFB}rendimiento}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}}       & \multicolumn{5}{c|}{\cellcolor[HTML]{CBCEFB}concentracion de acido}                                                                                                                                                                                                                                                                                                                                                                                                                                                               \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}Lote}   & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}1}                                                             & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}2}                                                             & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}3}                                                               & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}4}                                                                    & 5                                                                    \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}Lote 1} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}26\\    \\ A $\alpha$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}21\\    \\ B $\beta$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}19\\    \\ C $\gamma$\end{tabular}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}13\\    \\ D $\delta$\end{tabular}}        & \begin{tabular}[c]{@{}c@{}}21\\    \\  E $\eta$\end{tabular}         \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}Lote 2} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}22\\    \\ B $\gamma$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}26\\    \\  C$\delta$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}24\\    \\ D $\eta$\end{tabular}}     & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}16\\    \\  E $\alpha$\end{tabular}} & \begin{tabular}[c]{@{}c@{}}20\\    \\  A $\beta$\end{tabular}       \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}Lote 3} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}29\\    \\ C $\eta$\end{tabular}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}26\\    \\ D $\alpha$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}19\\    \\ E $\beta$\end{tabular}}    & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}18\\    \\ A $\gamma$\end{tabular}}        & \begin{tabular}[c]{@{}c@{}}16\\    \\ B $\delta$\end{tabular} \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}Lote 4} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}32\\    \\ D $\beta$\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}15\\    \\ E $\gamma$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}14\\    \\ A $\delta$\end{tabular}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}19\\    \\ B $\eta$\end{tabular}}          & \begin{tabular}[c]{@{}c@{}}27\\    \\ C $\alpha$\end{tabular}         \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{CBCEFB}Lote 5} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}25\\    \\ E $\delta$\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}18\\    \\ A $\eta$\end{tabular}}   & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}19\\    \\ B $ \alpha $\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}\begin{tabular}[c]{@{}c@{}}25\\    \\ C $\beta$\end{tabular}}         & \begin{tabular}[c]{@{}c@{}}21\\    \\ D $\gamma$\end{tabular}        \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 6}
\end{center}
\end{table}
...
\section{Diseño en Cuadrados de Youden}
...
>{\columncolor[HTML]{DAE8FC}}c |}
\hline
                & \multicolumn{5}{c|}{\cellcolor[HTML]{DAE8FC}\textbf{concentracion de acido}}                                                                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
\textbf{Lote}   & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}1}                                                     & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}2}                                                           & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}3}                                                     & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}4}                                                             & 5                                                           \\ \hline
\textbf{Lote 1} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}12\\    \\ A\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}24\\    \\ B\end{tabular}}        & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}10\\    \\ C\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}18\\    \\ D\end{tabular}}          & \begin{tabular}[c]{@{}c@{}}21\\    \\  E\end{tabular}      \\ \hline
\textbf{Lote 2} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}21\\    \\ B\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}26\\    \\  C\end{tabular}}       & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}24\\    \\ D\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}16\\    \\  E\end{tabular}} & \begin{tabular}[c]{@{}c@{}}20\\    \\  F\end{tabular}       \\ \hline
\textbf{Lote 3} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}20\\    \\ C\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}16\\    \\ D\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}19\\    \\ E\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}18\\    \\ F\end{tabular}}          & \begin{tabular}[c]{@{}c@{}}16\\    \\ A\end{tabular} \\ \hline
\textbf{Lote 4} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}22\\    \\ D\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}15\\    \\ E\end{tabular}}       & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}14\\    \\ F\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}19\\    \\ A\end{tabular}}          & \begin{tabular}[c]{@{}c@{}}27\\    \\ B\end{tabular}        \\ \hline
\textbf{Lote 5} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}15\\    \\ E\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}13\\    \\ F\end{tabular}}        & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}17\\    \\ A\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}25\\    \\ B\end{tabular}}          & \begin{tabular}[c]{@{}c@{}}21\\    \\ C\end{tabular}        \\ \hline
\textbf{Lote 6} & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}17\\    \\ F\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}11\\    \\ A\end{tabular}}        & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}12\\    \\ B\end{tabular}}  & \multicolumn{1}{c|}{\cellcolor[HTML]{DAE8FC}\begin{tabular}[c]{@{}c@{}}22\\    \\ C\end{tabular}}          & \begin{tabular}[c]{@{}c@{}}14\\    \\ D\end{tabular}        \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 7}
\end{center}
\end{table}
...
\item Variable respuesta: Rendimiento
\item Factor: Tiempo de reposo que tiene seis niveles. Es un factor de efectos fijos ya que viene decidido que niveles concretos se van a utilizar.
\item Bloques: Lotes y Concentraciones, con seis y cinco niveles, respectivamente y ambos son factores de efectos fijos.
\item Tamaño del experimento: Número total de observaciones (30).
\item Nombre: Rendimiento ;   Tipo: Numérico ;   Anchura: 2 ;   Decimales: 0
\end{itemize}
...
\item Factor Bloque:Tiempo\_de\_reposo\\
...
\hline
         & \multicolumn{4}{c|}{Antídoto}                                                                                            \\ \hline
Veneno   & \multicolumn{1}{c|}{Antídoto   1} & \multicolumn{1}{c|}{Antídoto   2} & \multicolumn{1}{c|}{Antídoto   3} & Antídoto   4 \\ \hline
Veneno 1 & \multicolumn{1}{c|}{4.5}          & \multicolumn{1}{c|}{11}           & \multicolumn{1}{c|}{4.5}          & 7.1          \\ \hline
Veneno 2 & \multicolumn{1}{c|}{2.9}          & \multicolumn{1}{c|}{6.1}          & \multicolumn{1}{c|}{3.5}          & 10.2         \\ \hline
Veneno 3 & \multicolumn{1}{c|}{2.1}          & \multicolumn{1}{c|}{3.7}          & \multicolumn{1}{c|}{2.5}          & 3.6          \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 8}
\end{center}
\end{table}
\end{itemize}
...
\subsubsection{El modelo con replicación}
...
\begin{center}
\begin{tabular}{|
>{\columncolor[HTML]{FFCCC9}}c |cccc|}
\hline
         & \multicolumn{4}{c|}{\cellcolor[HTML]{FFCCC9}Antídoto}                                                                                                                                                                                                                                                  \\ \hline
Veneno   & \multicolumn{1}{c|}{\cellcolor[HTML]{96FFFB}Antídoto 1}                      & \multicolumn{1}{c|}{\cellcolor[HTML]{96FFFB}Antídoto 2}                       & \multicolumn{1}{c|}{\cellcolor[HTML]{96FFFB}Antídoto 3}                      & \cellcolor[HTML]{96FFFB}Antídoto 4                       \\ \hline
Veneno 1 & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}4.5\\    \\ 4.3\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}11.0\\    \\ 7.2\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}4.5\\    \\ 7.6\end{tabular}} & \begin{tabular}[c]{@{}c@{}}7.1\\    \\ 6.2\end{tabular}  \\ \hline
Veneno 2 & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}2.9\\    \\ 2.3\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}6.1\\    \\ 12.4\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}3.5\\    \\ 4.0\end{tabular}} & \begin{tabular}[c]{@{}c@{}}10.2\\    \\ 3.8\end{tabular} \\ \hline
Veneno 3 & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}2.1\\    \\ 2.3\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}3.7\\    \\ 2.9\end{tabular}}  & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}2.5\\    \\ 2.2\end{tabular}} & \begin{tabular}[c]{@{}c@{}}3.6\\    \\ 3.3\end{tabular}  \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 9}
\end{center}
\end{table}

\begin{itemize}
\item Variable respuesta: Tiempo de supervivencia;
\item Factor: Tipo de veneno (tres niveles).
\item Factor: Tipo de antídoto (cuatro niveles).
\item Ambos factores de efectos fijos.
\item Tamaño del experimento: Número total de observaciones (24).
\end{itemize}
...
\begin{center}
\textbf{SCT=SCA+SCB+SCC+SC(AB)+SC(AC)+SC(BC)+SC(ABC)+SCR}
\end{center}

Que representan:

\begin{itemize}
\item SCT : Suma de Cuadrados Total,
\item SCA, SCB, SCC: Suma de Cuadrados entre los niveles de A,  de B y de C, respectivamente
\item SC(AB), SC(AC), SC(BC), SC(ABC), SCR: Suma de Cuadrados de las interacciones A×B, A×C, B×C, A×B×C y del error, respectivamente.
\end{itemize}

A partir de la ecuación básica del Análisis de la Varianza se pueden construir los cuadrados medios definidos como:

\begin{itemize}
\item Cuadrado medio total: CMT=(SCT)/(n-1)
\item Cuadrado medio de A: CMA=(SCA)/(a-1)
\item Cuadrado medio de B: CMB=(SCB)/(b-1)
\item Cuadrado medio de C: CMC=(SCC)/(c-1)
\item Cuadrado medio de las interacciones:
...
\begin{center}
\begin{tabular}{|
>{\columncolor[HTML]{FFCE93}}c |cccc|}
\hline
                  & \multicolumn{4}{c|}{\cellcolor[HTML]{FFCE93}Presión (B)}                                                                                                              \\ \hline
                  & \multicolumn{2}{c|}{\cellcolor[HTML]{CBCEFB}{\color[HTML]{000000} 25 psi}}        & \multicolumn{2}{c|}{\cellcolor[HTML]{CBCEFB}{\color[HTML]{000000} 30 psi}}        \\ \hline
                  & \multicolumn{2}{c|}{\cellcolor[HTML]{CBCEFB}{\color[HTML]{000000} Velocidad (C)}} & \multicolumn{2}{c|}{\cellcolor[HTML]{CBCEFB}{\color[HTML]{000000} Velocidad (C)}} \\ \hline
\% de Carbono (A) & \multicolumn{1}{c|}{200}                 & \multicolumn{1}{c|}{250}               & \multicolumn{1}{c|}{200}                           & 250                          \\ \hline
10                & \multicolumn{1}{c|}{10}                  & \multicolumn{1}{c|}{3}                 & \multicolumn{1}{c|}{5}                             & -1                           \\ \hline
12                & \multicolumn{1}{c|}{11}                  & \multicolumn{1}{c|}{2}                 & \multicolumn{1}{c|}{5}                             & -3                           \\ \hline
14                & \multicolumn{1}{c|}{2}                   & \multicolumn{1}{c|}{4}                 & \multicolumn{1}{c|}{-3}                            & 1                            \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico 10}
\end{center}
\end{table}
...
Como consecuencia de este resultado, replanteamos el modelo suprimiendo en primer lugar el efecto Carbono*Presión,para resolverlo suprimimos la interacción Carbono*Presión. La tabla ANOVA que corresponde a este modelo es la siguiente:
...
El efecto Presión*Velocidad sigue siendo no significativo por lo que lo suprimimos del modelo, para resolverlo suprimimos la interacción Presión*Velocidad. La tabla ANOVA que corresponde a este modelo es la siguiente:
...
\subsubsection{Diseño factorial de tres factores con replicación}
...
\begin{center}
\begin{tabular}{|
>{\columncolor[HTML]{67FD9A}}c |cccc|}
\hline
                  & \multicolumn{4}{c|}{\cellcolor[HTML]{67FD9A}Presión (B)}                                                                                                                                                                                                                                   \\ \hline
                  & \multicolumn{2}{c|}{\cellcolor[HTML]{00D2CB}25 psi}                                                                                                   & \multicolumn{2}{c|}{\cellcolor[HTML]{00D2CB}30 psi}                                                                                \\ \hline
                  & \multicolumn{2}{c|}{\cellcolor[HTML]{00D2CB}Velocidad (C)}                                                                                            & \multicolumn{2}{c|}{\cellcolor[HTML]{00D2CB}Velocidad (C)}                                                                         \\ \hline
\% de Carbono (A) & \multicolumn{1}{c|}{200}                                                   & \multicolumn{1}{c|}{250}                                                 & \multicolumn{1}{c|}{200}                                                   & 250                                                   \\ \hline
10                & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}10\\    \\ 20\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}3\\    \\ 5\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}5\\    \\ 9\end{tabular}}   & \begin{tabular}[c]{@{}c@{}}-1\\    \\ -3\end{tabular} \\ \hline
12                & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}11\\    \\ 9\end{tabular}}  & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}2\\    \\ 5\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}5\\    \\ 4\end{tabular}}   & \begin{tabular}[c]{@{}c@{}}-3\\    \\ 2\end{tabular}  \\ \hline
14                & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}2\\    \\ -1\end{tabular}}  & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}4\\    \\ 7\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}-3\\    \\ -2\end{tabular}} & \begin{tabular}[c]{@{}c@{}}1\\    \\ 3\end{tabular}   \\ \hline
\end{tabular}
\caption{Tabla de datos del Supuesto Práctico11}
\end{center}
\end{table}
...
\\
Como consecuencia de este resultado, replanteamos el modelo suprimiendo en primer lugar el efecto Carbono*Presión*Velocidad, cuya significación es mayor
...
\\
Suprimimos el efecto Presión*Velocidad que tiene una no significatividad más alta:
